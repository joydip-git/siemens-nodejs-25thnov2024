...
var Trainer = /*#__PURE__*/function (_Person) {
  function Trainer(id, name, salary, subjects) {
    ...
    _this = _callSuper(this, Trainer, [id, name, salary]);
  ...
  return _createClass(Trainer, [{
    key: "show",
    value: function show() {
      var partialInfo = _superPropGet(Trainer, "show", this, 3)([]);
      return "".concat(partialInfo, ", Subjects=").concat(this.subjects);
    }
  }]);
}(Person); //Object.setPrototypeOf(trainer.prototype, person.prototype)
var joydipTrainer = new Trainer(1, 'joydip', 1000, ['JS', 'C#']);
